...
async function seed() {
    ...
    // Universities
    const existingUniCount = await University_1.default.countDocuments();
    if (existingUniCount === 0) {
        console.log('🌱 Seeding universities...');
        for (const u of universities) {
            await University_1.default.create(u);
    ...
    // Resources
    const existingResourceCount = await Resource_1.default.countDocuments();
    if (existingResourceCount === 0) {
        console.log('🌱 Seeding resources...');
        await Resource_1.default.insertMany(resources);
