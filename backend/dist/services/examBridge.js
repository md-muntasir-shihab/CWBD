...
exports.ExamUnified = void 0;
exports.modernToRich = modernToRich;
exports.richToModern = richToModern;
/**
...
exports.ExamUnified = Exam_1.default;
/**
 * Map a modern-model payload to the rich model's field names.
 */
function modernToRich(input) {
    const mapped = { ...input };
...
//# sourceMappingURL=examBridge.js.map