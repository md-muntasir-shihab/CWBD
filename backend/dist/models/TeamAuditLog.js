...
const TeamAuditLogSchema = new mongoose_1.Schema({
    ...
    oldValueSummary: { type: mongoose_1.Schema.Types.Mixed, default: undefined },
    newValueSummary: { type: mongoose_1.Schema.Types.Mixed, default: undefined },
...
exports.default = mongoose_1.default.model('TeamAuditLog', TeamAuditLogSchema);
