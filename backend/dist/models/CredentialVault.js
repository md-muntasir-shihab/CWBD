...
const CredentialVaultSchema = new mongoose_1.Schema({
    ...
    updated_by: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', default: null },
}, { timestamps: true, collection: 'credential_vault' });
exports.default = mongoose_1.default.model('CredentialVault', CredentialVaultSchema);
