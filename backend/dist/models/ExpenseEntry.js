...
const ExpenseEntrySchema = new mongoose_1.Schema({
    category: {
        type: String,
    ...
    linkedStaffId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', default: null },
...
exports.default = mongoose_1.default.model('ExpenseEntry', ExpenseEntrySchema);
