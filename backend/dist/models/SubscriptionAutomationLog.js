...
const SubscriptionAutomationLogSchema = new mongoose_1.Schema({
    ...
    subscriptionId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'UserSubscription' },
    action: {
        type: String,
        required: true,
...
exports.default = mongoose_1.default.model('SubscriptionAutomationLog', SubscriptionAutomationLogSchema);
//# sourceMappingURL=SubscriptionAutomationLog.js.map