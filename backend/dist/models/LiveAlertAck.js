...
const LiveAlertAckSchema = new mongoose_1.Schema({
    alertId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'HomeAlert', required: true, index: true },
...
exports.default = mongoose_1.default.model('LiveAlertAck', LiveAlertAckSchema);
//# sourceMappingURL=LiveAlertAck.js.map