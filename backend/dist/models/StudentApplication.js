...
const StudentApplicationSchema = new mongoose_1.Schema({
    ...
    university_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'University', required: true },
...
exports.default = mongoose_1.default.model('StudentApplication', StudentApplicationSchema);
