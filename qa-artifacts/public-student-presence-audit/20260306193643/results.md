# Public + Student Presence Audit (20260306193643)

- Base URL: http://127.0.0.1:5274
- Started: 2026-03-06T19:36:43.235Z
- Ended: 2026-03-06T19:41:27.600Z
...
| 12 | student | `/dashboard` | Student Dashboard | WARN | - | No chart data yet. Complete exams to build your trend line. ; No badges yet. ; No exam history yet. | [screenshots/12-student-student-dashboard.png](screenshots/12-student-student-dashboard.png) |
| 13 | student | `/exams` | Student Exams | PASS | - | - | [screenshots/13-student-student-exams.png](screenshots/13-student-student-exams.png) |
| 14 | student | `/results` | Student Results | WARN | - | No results available yet. | [screenshots/14-student-student-results.png](screenshots/14-student-student-results.png) |
...
| 19 | student | `/support` | Student Support | WARN | - | No support tickets yet. | [screenshots/19-student-student-support.png](screenshots/19-student-student-support.png) |
