# Public + Student Presence Audit (20260306194238)

- Base URL: http://127.0.0.1:5274
- Started: 2026-03-06T19:42:38.742Z
- Ended: 2026-03-06T19:47:23.935Z
...
|---|---|---|---|---|---|---|---|
| 01 | public | `/` | Home | PASS | - | - | [screenshots/01-public-home.png](screenshots/01-public-home.png) |
| 02 | public | `/universities` | Universities | PASS | - | - | [screenshots/02-public-universities.png](screenshots/02-public-universities.png) |
| 03 | public | `/exam-portal` | Exam Portal | PASS | - | - | [screenshots/03-public-exam-portal.png](screenshots/03-public-exam-portal.png) |
...
| 12 | student | `/dashboard` | Student Dashboard | PASS | - | - | [screenshots/12-student-student-dashboard.png](screenshots/12-student-student-dashboard.png) |
| 13 | student | `/exams` | Student Exams | PASS | - | - | [screenshots/13-student-student-exams.png](screenshots/13-student-student-exams.png) |
| 14 | student | `/results` | Student Results | PASS | - | - | [screenshots/14-student-student-results.png](screenshots/14-student-student-results.png) |
...
| 19 | student | `/support` | Student Support | PASS | - | - | [screenshots/19-student-student-support.png](screenshots/19-student-student-support.png) |
