# Admin Sidebar Audit (20260306194732)

- Base URL: http://127.0.0.1:5273
- Started: 2026-03-06T19:47:32.054Z
- Ended: 2026-03-06T19:56:13.971Z
...
| Home Control | PASS | `/__cw_admin__/settings/home-control` | Home Control | - | [screenshots/03-home-control.png](screenshots/03-home-control.png) |
...
| News Area | PASS | `/__cw_admin__/news/dashboard` | News Dashboard | - | [screenshots/08-news-area.png](screenshots/08-news-area.png) |
...
| Students | PASS | `/__cw_admin__/students` | Students | - | [screenshots/11-students.png](screenshots/11-students.png) |
...
| Security Center | PASS | `/__cw_admin__/settings/security-center` | Security Center | - | [screenshots/18-security-center.png](screenshots/18-security-center.png) |
| System Logs | PASS | `/__cw_admin__/settings/system-logs` | System Logs | - | [screenshots/19-system-logs.png](screenshots/19-system-logs.png) |
| Admin Profile | WARN | `/__cw_admin__/settings/admin-profile` | Admin Profile | No action history found. | [screenshots/20-admin-profile.png](screenshots/20-admin-profile.png) |
