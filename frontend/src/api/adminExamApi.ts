...
/* ─── Exams ─── */
export const listAdminExams = () => api.get("/admin/exams").then((r) => r.data);
export const getAdminExam = (id: string) => api.get(`/admin/exams/${id}`).then((r) => r.data);
...
/* ─── Questions ─── */
export const listAdminExamQuestions = (examId: string) => api.get(`/admin/exams/${examId}/questions`).then((r) => r.data);
...
/* ─── Results ─── */
export const getAdminExamResults = (examId: string) => api.get(`/admin/exams/${examId}/results`).then((r) => r.data);
export const getAdminExamExports = (examId: string) => api.get(`/admin/exams/${examId}/exports`).then((r) => r.data);
export const publishExamResults = (examId: string) => api.post(`/admin/exams/${examId}/publish-results`).then((r) => r.data);
...
/* ─── Template download URLs (href, not axios) ─── */
